...
import tasksImg from '../../assets/tasks/tasks.png';
import {
  changeHowWorkFlag,
  changePlatformValue,
  changeRangeValue,
...
import { selectTasks } from '../../redux/slice/tasksSlice';
        ...
        <div className={styles.wrapperContent}>
          <div className={styles.mainContent}>
            <div className={styles.titleWrapper}>
              <h1 className={styles.title}>FC 24 Divisions Rivals Boost</h1>
            </div>
            <div className={styles.textBlocks}>
              <p className={styles.text}>Buy EA Sports FC Divisions Rivals to reach any division you want and obtain lots of various rewards for each rank! to reach the required division and get a wide variety of Divisions Rivals rewards. Forget about frustration of lost competitive games, reach top positions in leaderboards as quickly as possible with our FC 24 Divisions Rivals boosting service. </p>

            </div>
            <div className={styles.getBlock}>
              <h4 className={styles.getTitle}>WHAT YOU WILL GET</h4>
              <ul className={styles.getList}>
                <li className={styles.getString}>Chosen Division reached;</li>
                <li className={styles.getString}>Wins in Divisions Rivals mode obtained;</li>
                <li>Chance to obtain various rewards depending on the rank you choose.</li>
              </ul>
            </div>
          ...
          <div className={styles.formWrapper}>
            <form className={styles.form} onSubmit={formSubmit}>
              <div className={styles.formImageBlock}>
                <img src={tasksImg} alt="playoff" className={styles.formImage} />
