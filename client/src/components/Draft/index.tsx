...
import draftImg from '../../assets/draft/draft.png';
import {
  changeHowWorkFlag,
  changePlatformValue,
  changeRangeValue,
  changeRequirementFlag,
  changeStreamValue, selectDraft,
} from '../../redux/slice/draftSlice';
        ...
        <div className={styles.wrapperContent}>
          <div className={styles.mainContent}>
            <div className={styles.titleWrapper}>
              <h1 className={styles.title}>EA Sports FC FUT Draft Boost</h1>
            </div>
            <div className={styles.textBlocks}>
              <p className={styles.text}>Buy EA Sports FC FUT Draft and get up to 4 draft wins, obtaining packs with gold and players as your reward. FUT Draft is a special game mode, available in single-player and multiplayer variants. While online is significantly more difficult to participate in, it is also much more rewarding than its offline counterpart. And with our FC 24 FUT Draft boosting service, you will be able to skip all the difficulties and jump right to the rewarding part! </p>
            </div>
            <div className={styles.getBlock}>
              <h4 className={styles.getTitle}>WHAT YOU WILL GET</h4>
              <ul className={styles.getList}>
                <li className={styles.getString}>Chosen number of wins obtained in online draft;</li>
                <li className={styles.getString}>Get packs with coins and players as reward. In online mode, get twice as more!  </li>
              </ul>
            </div>
          ...
          <div className={styles.formWrapper}>
            <form className={styles.form} onSubmit={formSubmit}>
              <div className={styles.formImageBlock}>
                <img src={draftImg} alt="playoff" className={styles.formImage} />
